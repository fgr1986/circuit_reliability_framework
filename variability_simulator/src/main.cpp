...
static const std::string kAppVersion = "v3.1.0";
static const std::string kAppAuthor = "Fernando García, fgarcia@die.upm.es";
static const std::string kAppVersionDate = "23/06/2016";
...
int main(int argc, char** argv) {
	...
	//Scan sensitive nodes and create radiation scenarios
	if( !experiment.CreateVariationScenarios( 4 ) ){
	...
	//Scan sensitive nodes and create radiation scenarios
	if( !experiment.SimulateVariationScenarios( 5 ) ){
