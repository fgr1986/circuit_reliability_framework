...
pwd
rm -rf src bin libcircuit_reliability.so_release_3.2.0.tar.gz;
cp ../libcircuit_reliability.so_release_3.2.0.tar.gz .;
tar xvf libcircuit_reliability.so_release_3.2.0.tar.gz;
...
pwd
rm -rf src bin variability_simulator_release_3.2.0.tar.gz;
cp ../variability_simulator_release_3.2.0.tar.gz .;
tar xvf variability_simulator_release_3.2.0.tar.gz;
echo "Compiling variability simulator"
cd src/; make clean; make;
cp ../bin/variability_simulator_3.2.0 /simulation_data/circuit_reliability_framework/variability_simulator/bin/;
