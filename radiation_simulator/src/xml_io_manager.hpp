...
public:
 	...
 	* @param spectre_handler <RadiationSpectreHandler&> spectre simulations handler
	...
	bool ReadExperimentEnvironmentFromXML(
		...
		ExperimentEnvironment& experimentEnvironment, RadiationSpectreHandler& radiation_spectre_handler,
...
private:
	...
	bool ReadCadenceXML( const std::string &xml_cadence, int& statementCounter,
		ExperimentEnvironment& experimentEnvironment, RadiationSpectreHandler& spectre_handler );
 	...
 	* @param v <boost::property_tree::ptree::value_type const &> ptree value type node
 	* @param  statementcounter 
 	* @param  radiationSpectreHandler
 	* @param  circuitIOHandler
 	*  
 	* @return correctly read and set up <bool>
 	* 
	 */
	bool ProcessMagnitude(boost::property_tree::ptree::value_type const &v,
 	...
 	* @param radiationSpectreHandler <RadiationSpectreHandler&> radiationSpectreHandler mode
 	* 
 	* @return correctly read and set up <bool>
 	* 
 	*/
