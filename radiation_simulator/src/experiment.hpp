...
public:
 	...
 	* @return method correctly executed <bool>
 	*/
	bool CreateRadiatedScenarios( int stageNumber );
	/**
 	* @details Simulates the altered circuit scenarios
 	* @param stageNumber <int> Program stage
 	* @return method correctly executed <bool>
 	*/
	bool SimulateRadiatedScenarios( int stageNumber );
...
private:
	...
	/// Circuit radiator
	CircuitRadiator circuit_radiator;
	...
	/// Output xml files folder
	std::string xml_folder;
	/// Output ahdl components scenario folder
	std::string radiation_subcircuit_AHDL_folder;
