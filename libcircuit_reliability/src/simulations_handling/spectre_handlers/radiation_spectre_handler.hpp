...
#ifndef RADIATION_SPECTRE_HANDLER_H
#define RADIATION_SPECTRE_HANDLER_H
...
public:
	RadiationSpectreHandler();
	virtual ~RadiationSpectreHandler();
	...
	void set_radiation_subcircuit_AHDL_folder_path(std::string radiation_subcircuit_AHDL_folder_path) {
		this->radiation_subcircuit_AHDL_folder_path = radiation_subcircuit_AHDL_folder_path; }
	...
	/**
	* @brief Sets max_parallel_scenario_instances
	*
	* @param max_parallel_scenario_instances
	*/
	void set_max_parallel_scenario_instances( int max_parallel_scenario_instances ){
...
private:
	...
	std::string radiation_subcircuit_AHDL_folder_path;
	...
	// max parallel instances per scenario
	unsigned int max_parallel_scenario_instances;
	...
	/**
	 * @brief Creates the vector of CreateResultsSummary objects
	 *
	 * @return true if ok
	 */
